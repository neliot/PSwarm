...
color[][] menuTheme = {
// |   borderColour           fillColour               textColour      |
  {color(0  ,0  ,0  ,255),color(70 ,75 ,70 ,150),color(0  ,0  ,0  ,255)},
  {color(0  ,0  ,0  ,255),color(255,255,255,150),color(0  ,0  ,0  ,255)}
};
color[][] boxTheme = {
...
// | background           | grid1                | grid2               |  
  ...
  {color(250,250,250,100),color(100,100,100,100),color(50 ,50 ,50 ,100)}
};
